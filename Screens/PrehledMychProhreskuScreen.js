...
const PrehledMychProhreskuScreen = ({ navigation }) => {
  Connectivity();
  ...
  useEffect(() => {
    ...
    fetch(
      "https://pina.trialhosting.cz/api/prehledZapsanychProhresku/getMojeProhresky.php?tym=" +
      tymId +
      "&sezona=" +
      vybranaSezona +
      "&hrac=" +
...
export default PrehledMychProhreskuScreen;
